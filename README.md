...
- **hey siri** (optional, off by default). say "hey siri, skip song" / "close discord" / "what song is this" / "search up ___" / "type ___" and a bunch more. a little siri orb drops out of the notch and grows while you talk, it can talk back out loud, and theres an optional glowing screen border while it listens. full list is in the voice settings, and theres rgb joke modes for the orb and border
...
- hey siri is off by default and only uses your mic once you turn it on. its fully offline, nothing you say leaves your pc, and it only ever reacts to the commands in the list
